...
export default function RoomsRequestScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.bg }}>
      ...
      <GuideModalButton
        imageSource={require('../../assets/guides/Salas.jpg')}
        title="Guía - Reserva de Salas y Auditorio"
        subtitle="Flujograma y procedimiento para reserva de salas institucionales"
                  ...
                  <Card title="Disponibilidad y Horario" icon="calendar">
                    ...
                    <View style={[styles.selectionSummary, !isDesktop && { flexDirection: 'column', gap: 15, alignItems: 'flex-start' }]}>
                      ...
                      <View style={[styles.legendSmall, !isDesktop && { borderLeftWidth: 0, paddingLeft: 0, flexDirection: 'row', width: '100%', justifyContent: 'space-around', borderTopWidth: 1, borderTopColor: COLORS.line, paddingTop: 12 }]}>
                        ...
                        <View style={styles.legendItem}><View style={[styles.legendBox, { backgroundColor: '#FDA4AF' }]} /><Text style={styles.legendText}>Ocupado</Text></View>
                      </View>
                    </View>
                  </Card>
