...
export default function TransportRequestScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.bg }}>
      ...
      <GuideModalButton
        imageSource={require('../../assets/guides/Transporte.jpg')}
        title="Guía - Solicitud de Transporte"
        subtitle="Flujograma y procedimiento de asignación de vehículo oficial"
